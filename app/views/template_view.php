  ...
  <div class="navbar">
    <div class="navbar-inner">
      ...
      <div class="logo-box" style="background-color: orange">
        <a href="admin" class="logo-text"><span>Infintech&nbsp;Designs</span></a>
      </div><!-- Logo Box -->
...
<!--              </a>-->
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="/admin/dashboard" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span> Dashboard</a></li>
